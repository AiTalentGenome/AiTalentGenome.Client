...
export const FileUploadingStatus = ({
    ...
    return (
      <div className="flex flex-col items-center font-unbounded gap-20 animate-in fade-in zoom-in-95 duration-500 mb-10">
        ...
        <div className="flex flex-col items-center gap-4">
            ...
            {fileName && (
              <span className="font-manrope text-[12px] text-[#00566E] leading-4 text-center max-w-50 truncate mt-2">
                  {fileName}
              </span>
            )}
        </div>
        ...
        <div className="flex flex-col items-center gap-2">
            <div className="font-manrope font-semibold text-[#00566E] flex items-center gap-3">
